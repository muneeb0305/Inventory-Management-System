...
export default function SaleBarChart2({ data }) {
  ...
  const renderLegend = () => {
    return (
      <>
        <ul className={`flex justify-center ${toggle?' border-t-2 border-dark6':' border-t-2'}`}>
          <li className={`mx-3 text-green-500 flex items-center  ${toggle?' border-r-2 border-dark6':' border-r-2'} `}><ShoppingBagIcon className='h-4' />Reality Sales <span className='px-3 border-r-2'></span></li>
