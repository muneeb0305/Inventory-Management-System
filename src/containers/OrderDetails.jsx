                  ...
                  <div className="tab-content tab-space">
                    <div className={openTab === 1 ? "block" : "hidden"} id="link1">
                      <div className='bg-white rounded-lg border-2 shadow-lg p-3'>
                        <Table color="bg-red-500" tableData={Orders.orderPlaced} tableHeader={Headers} />
                      </div>
                    </div>
                    <div className={openTab === 2 ? "block" : "hidden"} id="link2">
                      <div className='bg-white rounded-lg border-2 shadow-lg p-3'>
                        <Table color="bg-green-500" tableData={Orders.orderReceived} tableHeader={Headers} />
                      </div>
                    </div>
                    <div className={openTab === 3 ? "block" : "hidden"} id="link3">
                      <div className='bg-white rounded-lg border-2 shadow-lg p-3'>
                        <Table color="bg-purple-500" tableData={Orders.orderPicked} tableHeader={Headers} />
                      </div>
                    </div>
                    <div className={openTab === 4 ? "block" : "hidden"} id="link3">
                      <div className='bg-white rounded-lg border-2 shadow-lg p-3'>
                        <Table color="bg-orange-500" tableData={Orders.orderPackaged} tableHeader={Headers} />
                      </div>.
                    </div>
                    <div className={openTab === 5 ? "block" : "hidden"} id="link3">
                      <div className='bg-white rounded-lg border-2 shadow-lg p-3'>
                        <Table color="bg-green-500" tableData={Orders.orderShipped} tableHeader={Headers} />
                      </div>
                    </div>
                    <div className={openTab === 6 ? "block" : "hidden"} id="link3">
                      <div className='bg-white rounded-lg border-2 shadow-lg p-3'>
                        <Table color="bg-green-500" tableData={Orders.orderDelivered} tableHeader={Headers} />
                      </div>
                    </div>
                  </div>
                </div>
